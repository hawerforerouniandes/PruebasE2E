...
| :---: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- | ------------------------- | --------------------------------------------------------------- | :----------------: | :----------------: |
|  01   | Escenario positivo con el objetivo de realizar login, crear y previsualizar un post con título                                                                                                                        | editarpostcypress1.spec.js | editarpostkraken1.feature | Hawer Alberto Forero Rey                                        |     :white_check_mark:     ||
