...
| :---: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- | ------------------------- | --------------------------------------------------------------- | :----------------: | :----------------: |
|  01   | Escenario positivo con el objetivo de realizar login, crear y previsualizar un post con título                                                                                                                        | editarpostcypress1.spec.js | 1.editarpostkraken1.feature | Hawer Alberto Forero Rey                                        |     :white_check_mark:     |(Kraken) Pool de datos aleatorio dinámico|
...
|  06   | Escenario positivo con el objetivo de realizar login, crear y asignar un tag a un post correspondiente                                                                                                              | editarpostcypress4.spec.js | editarpostkraken4.feature | Hawer Alberto Forero Rey                                        |     :white_check_mark:      ||
