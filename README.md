...
|  04   | Escenario negativo con el objetivo de realizar login, crear, publicar un post para posteriormente elimanrlo en estado publicado                                                                                     | editarpostcypress5.spec.js | editarpostkraken5.feature | Hawer Alberto Forero Rey                                        |     :no_entry:     |(Kraken) Pool de datos aleatorio dinámico|
|  05   | Escenario positivo con el objetivo de realizar login, crear y asignar un tag a un post correspondiente                                                                                                              | editarpostcypress4.spec.js | editarpostkraken4.feature | Hawer Alberto Forero Rey                                        |     :white_check_mark:      ||
