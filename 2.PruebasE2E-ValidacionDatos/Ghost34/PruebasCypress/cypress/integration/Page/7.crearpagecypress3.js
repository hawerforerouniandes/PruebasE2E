...
describe('Testing Ghost application Create new Page with three elements', () => {
    ...
    it('Test login and create new page with maximum characters allowed plus 1 in twitter optiones for title', () => {

      cy.fixture('datapool').then((dp)  => {

        var title = faker.name.title();
        var text = faker.random.alpha(dp.MaxTwitterTitle + 1);
