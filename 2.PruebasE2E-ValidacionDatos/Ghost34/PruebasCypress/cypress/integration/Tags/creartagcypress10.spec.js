...
describe('Testing negativo crear tag', () => {
    ...
    it('Crear tag', () => {
      ...
      cy.get('#meta-title').type(faker.datatype.string(71), {force: true, parseSpecialCharSequences: false} );
      //Alert with red number
      cy.get('#meta-title').parent().find('span').should('have.attr', 'style', 'color: rgb(226, 84, 64);');
      //Description Meta data
      cy.get('#meta-description').focus();
      cy.get('#meta-description').type(faker.datatype.string(157), {force: true, parseSpecialCharSequences: false} );
      //Alert with red number
      cy.get('#meta-description').parent().find('span').should('have.attr', 'style', 'color: rgb(226, 84, 64);');
      ...
      cy.get('#twitter-title').type(faker.datatype.string(71), {force: true, parseSpecialCharSequences: false} );
      //Alert with red number
      cy.get('#twitter-title').parent().find('span').should('have.attr', 'style', 'color: rgb(226, 84, 64);');
      //Description Twitter card
      cy.get('#twitter-description').focus();
      cy.get('#twitter-description').type(faker.datatype.string(157), {force: true, parseSpecialCharSequences: false} );
      //Alert with red number
      cy.get('#twitter-description').parent().find('span').should('have.attr', 'style', 'color: rgb(226, 84, 64);');
      ...
      cy.get('#og-title').type(faker.datatype.string(71), {force: true, parseSpecialCharSequences: false} );
      //Alert with red number
      cy.get('#og-title').parent().find('span').should('have.attr', 'style', 'color: rgb(226, 84, 64);');
      //Description Facebook card
      cy.get('#og-description').focus();
      cy.get('#og-description').type(faker.datatype.string(157), {force: true, parseSpecialCharSequences: false} );
      //Alert with red number
      cy.get('#og-description').parent().find('span').should('have.attr', 'style', 'color: rgb(226, 84, 64);');
