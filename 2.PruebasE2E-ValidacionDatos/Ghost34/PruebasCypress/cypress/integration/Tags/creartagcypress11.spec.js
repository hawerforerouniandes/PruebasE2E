...
describe('Testing negativo crear tag', () => {
    ...
    it('Crear tag', () => {
      ...
      cy.get('#meta-title').type(faker.datatype.string(70), {force: true, parseSpecialCharSequences: false} );
      ...
      cy.get('#meta-description').type(faker.datatype.string(156), {force: true, parseSpecialCharSequences: false} );
      //Alert with red number
      ...
      cy.get('#twitter-title').type(faker.datatype.string(70), {force: true, parseSpecialCharSequences: false} );
      //Alert with red number
      ...
      cy.get('#twitter-description').type(faker.datatype.string(156), {force: true, parseSpecialCharSequences: false} );
      //Alert with red number
      ...
      cy.get('#og-title').type(faker.datatype.string(70), {force: true, parseSpecialCharSequences: false} );
      //Alert with red number
      ...
      cy.get('#og-description').type(faker.datatype.string(156), {force: true, parseSpecialCharSequences: false} );
      //Alert with red number
