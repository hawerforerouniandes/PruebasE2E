...
Scenario: Como usuario 1 ingreso a la aplicacion y creo una pagina web con un video adjunto
    ...
    And I take screenshot of step "1" and scenario "page-2"
    And I wait for 2 seconds
    And I click sign in
    And I wait for 10 seconds
    And I take screenshot of step "2" and scenario "page-2"
    And I click pages
    And I wait for 2 seconds
    And I take screenshot of step "3" and scenario "page-2"
    And I click new page
    And I wait for 2 seconds
    And I take screenshot of step "4" and scenario "page-2"
    ...
    And I wait for 2 seconds
    And I take screenshot of step "5" and scenario "page-2"
    And I select the divider element
    And I wait for 2 seconds
    And I take screenshot of step "6" and scenario "page-2"
    And I select the list of elements
    And I wait for 2 seconds
    And I take screenshot of step "7" and scenario "page-2"
    And I select the youtube link element
    And I wait for 2 seconds
    And I fill the youtube link "<URLLINK>"
    And I take screenshot of step "8" and scenario "page-2"
    And I wait for 10 seconds
    And I return to list of pages
    And I take screenshot of step "9" and scenario "page-2"
