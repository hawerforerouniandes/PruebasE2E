describe('Testing positivo crear post', () => {
    ...
    it('Crear post', () => {
      ...
      body.find("textarea").first().type("Prueba crear post", { force: true });
      ...
      //Validate draft post
      cy.get('.gh-posts-list-item').contains('Draft').first().parent().contains("Prueba crear post").should('be.visible')
